...
if(save_graph){
ggsave("../plots/ace_ht_facet_atp.jpg", height=8, width=graphic_width_short)
}
...
if(save_graph){
ggsave("../plots/ace_ht_facet_wta.jpg", height=8, width=graphic_width_short)
}
...
<!-- if(save_graph){ -->
<!-- ggsave("../plots/aces_median_percent_BW2.jpg", height=8, width=graphic_width_long) -->
<!-- } -->
...
if(save_graph){
ggsave("../plots/aces_median_percent_BW1.jpg", height=8, width=graphic_width_long)
}

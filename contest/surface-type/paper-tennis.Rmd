...
```{r, fig.height=3.5, fig.width=10, fig.align='center', fig.cap = "\\label{fig:home-court} A home court advantage does not appear to exist in any of the grand slams after we account for the number of players from a given country."}
...
```{r, fig.height=3.8, fig.width=8, out.width="80%", fig.align='center', fig.cap = "\\label{fig:spain-clay} We find that spaniards win more often at the French Open than other slams, even though their ranking is, on average, lower in the FO."}
...
```{r, fig.height = 3.8, fig.width=10, fig.cap ="\\label{fig:mixed-mods-ests}Estimated fixed effects for all seven models and player-level effects for Williams, Federer and Nadal under the ind_no_ioc model."}
...
```{r, fig.height = 3.4, fig.width=10, fig.cap = "\\label{fig:mixed-mods-stats}Estimated player-level effects for Williams, Federer and Nadal when modeling aces, net winners, and unforced errors."}

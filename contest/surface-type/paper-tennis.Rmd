...
```{r, fig.height=3.8, fig.width=8, out.width="80%", fig.align='center',  fig.pos = 'H',  fig.cap = "\\label{fig:spain-clay} We find that spaniards win more often at the French Open than other slams, even though their ranking is, on average, lower in the FO."}
...
```{r, out.width="70%", fig.width=7, fig.height=3.4, fig.align='center', fig.cap= "\\label{fig:ue-ace}We see Wim. matches tend to have more aces and fewer unforced errors than the other tournaments."}
...
```{r, fig.height = 3.8, fig.width=10, fig.cap ="\\label{fig:mixed-mods-ests}Estimated fixed effects for all seven models (left plot) and player-level effects for Williams, Federer and Nadal under the ind_no_ioc model."}
